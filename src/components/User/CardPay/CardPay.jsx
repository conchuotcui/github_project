...
const CardPay = () => {
  ...
  const handleColorChange = (event) => {
    ...
    if (products.products.colors) {
      const selectedColor = products.products.colors.find(
      ...
      <main className="main-cardpay container">
        <div className="group-cardpay container">
          ...
          <div class="container mt-3">
            <h2>Cấu hình { products?.products?.title}</h2>
          
            <table className="table table-borderless" style={{ width: "500px", marginLeft: "0%"  , marginTop:"20px"}}>
  <thead>
    
  </thead>
  <tbody>
    <tr>
      <td className="set-lock" style={{ fontSize: "16px", fontWeight: "500", backgroundColor: "#f5f5f5", textAlign: "left" }}>
        Màn hình :
      </td>
      <td style={{ fontSize: "16px", backgroundColor: "#f5f5f5", textAlign: "left" }}>{products?.products?.screen}</td>
    </tr>
    <tr>
      <td className="set-lock" style={{ fontSize: "16px", fontWeight: "500", textAlign: "left" }}>Hệ điều hành :</td>
      <td style={{ fontSize: "16px", textAlign: "left" }}>{products?.products?.operatingSystem}</td>
    </tr>
    <tr>
      <td className="set-lock" style={{ fontSize: "16px", fontWeight: "500", backgroundColor: "#f5f5f5", textAlign: "left" }}>Chip :</td>
      <td style={{ fontSize: "16px", backgroundColor: "#f5f5f5", textAlign: "left" }}>{products?.products?.chip}</td>
    </tr>
    <tr>
      <td className="set-lock" style={{ fontSize: "16px", fontWeight: "500", textAlign: "left" }}>Ram :</td>
      <td style={{ fontSize: "16px", textAlign: "left" }}>{products?.products?.ram}</td>
    </tr>
    <tr>
      <td className="set-lock" style={{ fontSize: "16px", fontWeight: "500", backgroundColor: "#f5f5f5", textAlign: "left" }}>Dung lượng lưu trữ :</td>
      <td style={{ fontSize: "16px", backgroundColor: "#f5f5f5", textAlign: "left" }}>{products?.products?.storageCapacity}</td>
    </tr>
    <tr>
      <td className="set-lock" style={{ fontSize: "16px", fontWeight: "500", textAlign: "left" }}>Cổng kết nối :</td>
      <td style={{ fontSize: "16px", textAlign: "left" }}>{products?.products?.connector}</td>
    </tr>
    <tr>
      <td className="set-lock" style={{ fontSize: "16px", fontWeight: "500", backgroundColor: "#f5f5f5", textAlign: "left" }}>Camera trước :</td>
      <td style={{ fontSize: "16px", backgroundColor: "#f5f5f5", textAlign: "left" }}>{products?.products?.frontCamera}</td>
    </tr>
    <tr>
      <td className="set-lock" style={{ fontSize: "16px", fontWeight: "500", textAlign: "left" }}>Camera sau :</td>
      <td style={{ fontSize: "16px", textAlign: "left" }}>{products?.products?.rearCamera}</td>
    </tr>
    <tr>
      <td className="set-lock" style={{ fontSize: "16px", fontWeight: "500", backgroundColor: "#f5f5f5", textAlign: "left" }}>Pin và Cáp sạc :</td>
      <td style={{ fontSize: "16px", backgroundColor: "#f5f5f5", textAlign: "left" }}>{products?.products?.rechargeableBatteries}</td>
    </tr>
    <tr>
      <td className="set-lock" style={{ fontSize: "16px", fontWeight: "500", textAlign: "left" }}>Hãng :</td>
      <td style={{ fontSize: "16px", textAlign: "left" }}>{products?.products?.theFirm}</td>
    </tr>
  </tbody>
</table>
