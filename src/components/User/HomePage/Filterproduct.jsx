...
const Filterproduct = () => {
  const updata = () => toast("Đang được cập nhật!");
      ...
      <section className="info-depict">
        <div>
          ...
          <p>
            ...
            <br />- Những sản phẩm có số người mua cao và được đánh giá tốt (4-5
            sao) của người dùng bạn nên ưu tiên chọn mua. <br />- Những sản phẩm
            có đánh giá từ 3 sao trở xuống và rất ít người mua thì cần phải cân
